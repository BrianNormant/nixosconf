...

{
  ...
  home-manager.users.brian = { pkgs, ...}: {
    home.packages = [ pkgs.waybar pkgs.cava pkgs.unison ];
    ...
    programs.git = {
      enable = true;
      userName = "BrianNixLaptop";
      userEmail = "briannormant@gmail.com";
    };


    services.unison.enable = true;
    services.unison.package = pkgs.unison;
    services.unison.pairs = {
      "wallpapers" = { roots = [ "/home/brian/Wallpapers" "ssh://BrianNixDesktop//home/brian/Wallpapers" ]; };
      "music" = { roots = [ "/home/brian/Music" "ssh://BrianNixDesktop//home/brian/Music" ]; };
      "prog" = { roots = [ "/home/brian/Prog" "ssh://BrianNixDesktop//home/brian/Prog" ]; };
    };
...
LOGIN="FALSE"
for E in /dev/tty[0-9]* ; do
    if [[ $TTY == $E ]]; then
        LOGIN="TRUE"
        break
    fi;
done
if [[ $LOGIN == "FALSE" && -z "$TMUX" ]]; then
    #Set up $TERM
...
# Some programs need SUID wrappers, can be configured further or are
  ...
  # services.openssh.settings.AllowUsers = [ "brian" ];

  # Open ports in the firewall.
  networking.firewall.allowedTCPPorts = [ 42069 42070 ];
